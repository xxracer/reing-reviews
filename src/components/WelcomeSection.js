...
const WelcomeSection = () => {
  const [content, setContent] = useState({
    ...
    `,
    welcomeImage: [{ url: 'https://static.wixstatic.com/media/c5947c_bf5a3cd828194df2944c8bb4eaf4cae0~mv2.jpg', align: 'center', width: '100%' }],
  });
  ...
  const image = content.welcomeImage && content.welcomeImage[0] ? content.welcomeImage[0] : { url: '', align: 'center', width: '100%' };
